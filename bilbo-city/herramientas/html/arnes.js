...
js=js.slice(0,i)+`global.__={S,player,MISIONES,empezarMision,avanzarPaso,objetivo,cerrarDlg,enemigos,
 ...
 real:cv,dib,MOB,colocarCalle,BARRIOS,barrioDe,distDe,Tc,rodable,sembrar,azar,MONTE,SPR,HOJAS,ICO,CURROS,ARMAS,TILE,PROP,VEH,PALETA,ORDEN_POSES,ARQ,hoja,SUELO_I,PARED_I,PUERTA_I,PASO_I,MUEBLES,sprMueble,piezasDe,TS_INT,M_INT,BLANDO_I,PISABLE_I,UNITARIO_I,
 ...
 MOB_PIEZA,SIEMBRA,gaviotas,AVE,actGaviotas,SIEMBRA_TEJADO,TOPE_ALTO,ALTO_TAPA,cajaProp,cajaJugador,tapa,plantar,anclaMob,siluetas:()=>siluetas};
