...
public static class Ciudad {
    ...
    static readonly string[] ATLAS = {
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTFFF",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTF",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTT",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTT",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFUUUUFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTT",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFUUUUUUFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTTT",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFUUUUUUUUFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFUUUUUUUUUFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFFFFFDDDDDDDDDDDFFFFFFFFFFFFFFFFFFFFFFFFFFFFFUUUUUUUUUUFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFFFDDDDDDDDDDDDDDDDFFFFFFFFFFFFFFFFFFFFFFFFFFUUUUUUUUUUUFFFFFFFFFFFFFFFFFFFFFTTTTFFFTTTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFFFFFFFFFUUUUUUUUUUUFFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFFFFFFFUUUUUUUUUUUUFFFFFFFFFFFFFFFFFFTTTTTTTTTTTTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFFFFFUUUUUUUUUUUUFFFFFFFFFFFFFFFFFGTTTTTTTTTTTTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFFFFUUUUUUUUUUUUUFFFFFFFFFFFFFFFGGGTTTTTTTTTTTTTTTTTTTTTTTTTTT",
        "FFFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFFFUUUUUUUUUUUUUUFFFFFFFFFFFFFGGGGGTTTTTTTTTTTTTTTTTTTTTTTTTT",
        "DDDFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFFFUUUUUUUUUUUUUUUUUUUFFFFFFFGGGGGGGTTTTTTTTTTTTTTTTTTTTTTTTT",
        "DDDDFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFFFFUUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGTTTTTTPPPPPPPPPPTTTTTTTF",
        "DDDDDDFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFFFFFDUUUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGTTTTTTPPPPPPPPPPTTTTTTTF",
        "DDDDDDDFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDFFFFDDDUUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGTTTTTPPPPPPPPPPTTTTTTFF",
        "DDDDDDDDDFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDFDDDDDUUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGGTTTTPPPPPPPPPPTTTTTTFF",
        "DDDDDDDDDDFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGGGTTTPPPPPPPPPPTTTTTFFF",
        "DDDDDDDDDDDFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGGGTTTPPPPPPPPPPTTTTTFFF",
        "DDDDDDDDDDDFFFFFFDDDDDDDDDPPPPPPPPDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGGGGSSSPPPPPPPPPPTTTTFFFF",
        "DDDDDDDDDDDDFFFFFFFDDDDDDDPPPPPPPPDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGGGSSSSPPPPPPPPPPTTTTFFFF",
        "DDDDDDDDDDDDDFFFFFFFDDDDDDPPPPPPPPDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGGSSSSSSSSSSSSTTTTTTFFFFF",
        "OOODDDDDDDDDDDFFFFFFFDDDDDPPPPPPPPDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGSSSSSSSSSSSSSSSSTTFTTTTT",
        "OOOOODDDDDDDDDDFFFFFFFDDDDPPPPPPPPDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGSSSSSSSSSSSSSSSSSSTTTTTT",
        "OOOOOOODDDDDDDDDFFFFFFFDDDPPPPPPPPDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGGSSSSSSSSSSSSSSSSSSSSSTTTT",
        "OOOOOOOOOODDDDDDDFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUGGGGGGGGGGGGGSSSSSSSSSSSSSSSSSSSSSSSTTT",
        "OOOOOOOOOOOODDDDDDFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUXXXXXXXXXXAAUGGGGGGGGGGGGSSSSSSSSSSSSSSSSSSSSSSSSSST",
        "OOOOOOOOOOOOOODDDDDFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDDUUUXXXXXXXXXXXXXXXAAAAAAAGGGGGGGSSPPPPPPPPSSSSSSSSSSSSSSSSSS",
        "OOOOOOOOOOOOOOOOODDDFFFFFFFFDDDDDDDDDDDDDDDDDDDDDDDDIXXXXXXXXXXXXXXXXXAAAAAAAAAAGGGGSSPPPPPPPPSSSSSSSSSSSSSSSSSS",
        "OOOOOOOOOOOOOOOOOOODDFFFFFFDDDDDDDDDDDDDDDDDDDDDDDIIIXXXXXXXXXXXXXXXXAAAAAAAAAAAAAGSSSPPPPPPPPSSSSSSSSSSSSSSSSSS",
        "OOOOOOOOOOOOOOOOOOOOODDFDDDDDDDDDDDDDDDDDDDDDDDDIIIIIIXXXXXXXXXXXXXXXAAAAAAAAAAAAAACSSPPPPPPPPSSSSSSSSSSSSSSSSSS",
        "OOOOOOOOOOOOOOOOOOOOOOODDDDDDDDDDDDDDDDDDDDDDDIIIIIIIIIXXXXXXXXXXXXXXAAAAAAAAAAAAAACCSPPPPPPPPSSSSSSSSSSSSSSSSSS",
        "OOOOOOOOOOOOOOOOOOOOOOOOOODDDDDDDDDDDDDDDDDDIIIIIIIIIIIIXXXXXXXXXXXXAAAAAAAAAAAAAAACCCPPPPPPPPSSSSSSSSSSSSSSSSSS",
        "OOOOOOOOOOOOOOOOOOOOOOOOOOOZZZZZDDDDDDDDDDDIIIIIIIIIIIIIIXXXXXXXXXXXAAAAAAAAAAAAAAACCCCCCSSSSSSSSSSSSSSSSSSSSSSS",
        "FOOOOOOOOOOOOOOOOZZZZZZZZZZZZZZZZDDDDDDDDIIIIIIIIIIIIIIIIIXXXXXXXXXAAAAAAAAAAAAAAAACCCCCCCSSSSSSSSSSSSSSSSSSSSSS",
        "FOOOOOOOOOOOZZZZZZZZZZZZZZZZZZZZZBBBBBDDBBIIIIPPPPPIIIIIIIIXXXXXXXXAAAAAAAAAAAAAAAACCCCCCCCCSSSSSSSSSSSSSSSSSSCC",
        "FFOOOOOOOOOZZZZZZZZZZZZZZZZZZZZZZZBBBBBBBBIIIPPPPPPPIIIIIIIIIXXXXXAAAAAAAAAAAAAAAAACCCCCCCCCCCSSSSSSSSSSSSSCCCCC",
        "FFOOOOOOOOOZZZZZZZZZZZZZZZZZZZZZZZBBBBBBBBBIIPPPPPPPPPIIIIIIIIIIXXAAAAAAAAAAAAAAAAACCCCCCCCCCCCSSSSSSSSSSCCCCCCC",
        "FFFOOOOOOOZZZZZZZZZZZZZZZZZZZZZZZBBBBBBBBBEEPPPPPPPPPPIIIIIIIIIIIAAAAAAAAAAAAAAAAAACCCCCCCCCCCCCCCCSSSCCCCCCCCCC",
        "FFFOOOOOOOZZZZZZZZZZZZZZZZZZZZZZBBBBBBBBBEEEEPPPPPPPPPPIIIIIIIIIIAAAAAAAAAAAAAAAAAAMCCCCCCCCCCCCCCCCCCCCCCCCCCCC",
        "FFFFOOOOOOOZZZZZZZZZZZZZZZZZZZZZBBBBBBBBBEEEEEPPPPPPPPPIIIIIIIIIIIAAAAAAAAAAAAAAAAMMMMMCCCCCCCCCCCCCCCCCCCCCCCCC",
        "FFFFOOOOOOOOZZZZZZZZZZZZZZZZZZZBBBBBBBBBBEEEEEEPPPPPPPPIIIIIIIIIIIAAAAAAAAAAAAAAAAMMMMMMMMCCCCCCCCCCCCCCCCCCCCCC",
        "FFFFFOOOOOOOOZZZZZZZZZZZZZZZZZBBBBBBBBBBEEEEEEEEPPPPPPPPIIIIIIIIIIAAAAAAAAAAAAAAAMMMMMMMMMMMMCCCCCCCCCCCCCCCCCCC",
        "FFFFFFOOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBEEEEEEEEEIIIIIIIIIIIIIIIIRRRAAAAAAAAAAAAMMMMMMMMMMMMMMMMMMCCCCCCCCCCCCCC",
        "FFFFFFFOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBEEEEEEEEEIIIIIIIIIIIIIIIRRRRRAAAAAAAAAAMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
        "FFFFFFFFOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBEEEEEEEEIIIIIIIIIIIIIIRRRRRRRRAAAAAAAMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
        "FFFFFFFFOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBEEEEEEEEIIIIIIFIIIIIIRRRRRRRRRRRRAAAAFFMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
        "FFFFFFFOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBEEEEEEEIIIIIFFIIIIIRRRRRRRRRRRRRRRAMFMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
        "FFFFFFFOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBBEEEEEEIIIIIFIIIIIRRRRRRRRRRRRRRRRRMFMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM",
        "FFFFFFOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBBBEEEEEIIIIFFIPPPPPPPPRRRRRRRRRRRRRMFMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMF",
        "FFFFFFOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBBBBBBBBIIIFFFIPPPPPPPPRRRRRRRRRRRRRFFMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMFFF",
        "FFFFFOOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBBBBBBBBIIIFFFIPPPPPPPPRRRRRRRRRRRRRFFMMMMMMMMMMMMMMMMMMMMMMMMMMMMFFFFF",
        "FFFFFOOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBBBBBBBBBIFFFFRPPPPPPPPRRRRRRRRRRRRRFMMMMMMMMMMMMMMMMMMMMMMMMMMMFFFFFFF",
        "FFFFOOOOOOOOOOOOOOOOOOOOOOOOBBBBBBBBBBBBBBBBBBBBBBFFFFRRPPPPPPPPRRRRRRRRRRRRRFMMMMMMMMMMMMMMMMMMMFFFFFFFFFFFFFFF",
        "FFFOOOOOOOOOOOOOOOOOOOOOFOOOBBBBBBBBBBBBBBBBBBBBBFFFFFRRPPPPPPPPRRRRRRRRRRRRFRRMMMMMMMMMMMMMMMMMFFFFFFFFFFFFFFFF",
        "FFFOOOOOOOOOOOOOOOOOOOOFOOOBBBBBBBBBBBBBBBBBBBBBFFFFFFRRRRRRRRRRRRRRRRRRRRRRFRRMMMMMMMMMMMMMMMMMFFFFFFFFFFFFFFFF",
        "FFFOOOOOOOOOOOOOOOOOOOFOOOOBBBBBBBBBBBBBBBBBBBBFFFFFFRRRRRRRRRRRRRRRRRRRRRRRFRRMMMMMMMMMMMMMMMMFFFFFFFFFFFFFFFFF",
        "FFFOOOOOOOOOOOOOOOOOOFFOOOOBBBBBBBBBBBBBBBBBBBFFFFFFFRRRRRRRRRRRRRRRRRRRRRRFFRRRMMMMMMMMMMMMMMFFFFFFFFFFFFFFFFFF",
        "FFOOOOOOOOOOOOOOOOOFFFFOOOOBBBBBBBBBBBBBBBBBBFFFFFFFFRRRRRRRRRRRRRRRRRRRRRFFFRRRMMMMMMMMMMMMMFFFFFFFFFFFFFFFFFFF",
        "FFOOOOOOOOOOOOOOOOFFFFFOOOOBBBBBBBBBBBBBBBBBFFFFFFFFFRRRRRRRRRRRRRRRRRRRRFFFFRRRRMMMMMMMMMMFFFFFFFFFFFFFFFFFFFFF",
        "FFOOOOOOOOOOOOOOOFFFFFFOOOOBBBBBBBBBBBBBBBBFFFFFFFFFFRRRRRRRRRRRRRRRRRRRFFFFFFRRRMMMMMMMMMFFFFFFFFFFFFFFFFFFFFFF",
        "FOOOOOOOOOOOOOOFFFFFFFFOOOOBBBBBBBBBBBBBBFFFFFFFFFFFFRRRRRRRRRRRRRRRRRRFFFFFFFFRRRMMMMMMMFFFFFFFFFFFFFFFFFFFFFFF",
        "FOOOOOOOOOOOOOFFFFFFFFFFOOOBBBBBBBBBBBBFFFFFFFFFFFFFFRRRRRRRRRRRRRRRRRFFFFFFFFFFRRMMMMMMFFFFFFFFFFFFFFFFFFFFFFFF",
        "FOOOOOOOOOOOOFFFFFFFFFFFFOOBBBBBBBBBFFFFFFFFFFFFFFFFRRRRRRRRRRRRRRRRRRFFFFFFFFFFFRRMMMMFFFFFFFFFFFFFFFFFFFFFFFFF",
        "FOOOOOOOOOOOFFFFFFFFFFFFFFOBBBBBBBFFFFFFFFFFFFFFFFFFRRRRRRRRRRRRRRRRRFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
        "FFOOOOOOOOFFFFFFFFFFFFFFFFFBBBBBBFFFFFFFFFFFFFFFFFFFRRRRRRRRRRRRRRRRFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
        "FFOOOOOOOOFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFRRRRRRRRRRRRRRRFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
        "FFFFOOOOFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFRRRRRRRRRRRRFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFRRRRRRRRRRFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
    };
    ...
    static readonly Vector2[] RIA = {
        new Vector2(446,152), new Vector2(424,160), new Vector2(404,168), new Vector2(384,164),
        new Vector2(364,152), new Vector2(344,140), new Vector2(324,128), new Vector2(300,120),
        new Vector2(276,116), new Vector2(252,116), new Vector2(228,120), new Vector2(204,128),
        new Vector2(180,140),  new Vector2(156,156),  new Vector2(132,172),  new Vector2(108,184),
        new Vector2(84,184),  new Vector2(64,172),  new Vector2(48,152),  new Vector2(32,128),
        new Vector2(16,104),   new Vector2(0,88)
    };
    static readonly Vector2[] CANAL = {
        new Vector2(140,152), new Vector2(116,146), new Vector2(92,142), new Vector2(68,134), new Vector2(52,120)
    };
    ...
    public static void Generar() {
        ...
        // 6 · la ría y el canal
        LineaRio(RIA, 13, 21, Suelo.Agua);
        LineaRio(CANAL, 10, 12, Suelo.Agua);
