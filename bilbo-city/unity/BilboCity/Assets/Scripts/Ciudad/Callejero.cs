...
public static class Callejero {
    ...
    public static readonly Calle[] Calles = {
        ...
        C("Atxetabidea", 1089,167, 1113,130, 1255,46),
        ...
        C("Azpeitia Sancho de", 221,244, 539,230),
        ...
        C("Begoñazpi", 1087,324, 1193,157, 1189,139),
        ...
        C("Bilbao Izaurieta", 157,262, 365,389),
        ...
        C("Briñas Luis", 538,377, 536,449, 820,527),
        ...
        C("Campuzano Emilio", 1009,404, 654,349),
        ...
        C("Capuchinos de Basurtu", 468,434, 604,551),
        ...
        C("Cortes Pedro Médico Municipal", 861,143, 1016,259),
        ...
        C("Epalza", 821,174, 834,175, 923,268),
        ...
        C("Euskalduna", 505,297, 552,289, 807,374),
        ...
        C("Jardines", 671,271, 828,274, 917,355, 1193,228, 1193,190, 1212,224),
        C("Jardintxikerra", 627,550, 628,550),
        C("Jardín de Zorrotza", 20,254, 86,331),
        ...
        C("Obreros Talleres Deusto", 410,272, 362,185, 593,116),
        ...
        C("Siervas de Jesús", 675,153, 885,346, 1131,140),
        C("Sirgueras", 81,260, 168,324, 300,407),
        ...
        C("Urquijo", 532,406, 764,380, 817,334),
        ...
        C("Zumalacárregui", 963,174, 1032,218, 1132,152, 1190,335),
