...
| Casilla de interior | **16×16 px** **[V]** | Dentro de un sitio la casilla no es la de la calle: mide **0,80 m** —el ancho de una puerta de paso— y se dibuja a 16 px, o sea **20 px por metro**. Es la densidad a la que está dibujada la gente (34 px para 1,70 m), y por eso dentro el personaje sale **a escala de verdad** y no con la sobreescala de la calle: en una habitación de diez metros no hace falta agrandar a nadie para verlo, y en cambio se nota enseguida si una cama mide más que quien duerme en ella. |
